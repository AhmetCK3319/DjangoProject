...
def add_cart(request,product_id):
    ...
    if current_user.is_authenticated:
        ...
        if is_cart_item_exists:
            ...
            # ex_var_list listesi varolan varyasyonları temsil ederken, id listesi ilgili CartItem nesnelerinin kimliklerini temsil eder.
            ex_var_list=[]
            id=[]
            ...
            if product_variation in ex_var_list:
                ...
                #Eğer sepet içeriğindeki varyasyonlar, eklenmek istenen varyasyonlarla aynıysa, bu ürün miktarını artırır.
                item.quantity +=1
                item.save()
            else:
                #Eğer aynı varyasyonlar mevcut değilse, yeni bir CartItem nesnesi oluşturur ve varyasyonları ekler.
